                        ...
                        <div className="space-y-6 mb-8">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-[var(--text-muted)]">Contact us by phone or email and we'll get back to you within 24-48 hours.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-4">
                                <div className="w-10 h-10 rounded-full bg-[var(--sage-100)] flex items-center justify-center flex-shrink-0">
                        ...
                        <div className="card bg-[var(--sage-50)] border-[var(--sage-200)]">
                            ...
                            <ul className="space-y-3 text-sm">
                                <li className="flex items-center gap-3">
                                    ...
                                    <a href="mailto:crystal.a.hank@gmail.com" className="text-[var(--sage-700)] hover:underline">
